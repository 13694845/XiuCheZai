...
#define XCZCircleDetailWriteViewTextViewPWordText @"说说您的看法"

@interface XCZCircleDetailWriteView()<UITextViewDelegate>
...
@implementation XCZCircleDetailWriteView
...
//        self.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.08];
        ...
        commentPlaceholderLabel.text = XCZCircleDetailWriteViewTextViewPWordText;
...
{
    if ([self.delegate respondsToSelector:@selector(circleDetailWriteView:commentHeaderLeftBtnDidClick:)]) {
        [self.delegate circleDetailWriteView:self commentHeaderLeftBtnDidClick:commentHeaderLeftBtn];
    }
}

- (void)commentHeaderRightBtnDidClick:(UIButton *)commentHeaderRightBtn
{
    if ([self.delegate respondsToSelector:@selector(circleDetailWriteView:commentHeaderRightBtnDidClickWithText:)]) {
        [self.delegate circleDetailWriteView:self commentHeaderRightBtnDidClickWithText:self.commentTextView.text];
    }
}
...
- (void)textViewDidChange:(UITextView *)textView
{
    if (textView.text.length) {
        ...
        self.commentPlaceholderLabel.text = XCZCircleDetailWriteViewTextViewPWordText;
    }
}
