//
//  XCZCircleUserListViewController.m
//  XiuCheZai
//
...
#import "XCZConfig.h"
#import "XCZCircleUserListCell.h"
#import "XCZPersonInfoViewController.h"
#import "MBProgressHUD+ZHM.h"
#import "XCZPersonWebViewController.h"

@interface XCZCircleUserListViewController() <UITableViewDataSource, UITableViewDelegate, XCZCircleUserListCellDelegate>
...
@implementation XCZCircleUserListViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    XCZCircleUserListCell *cell = [self.tableView dequeueReusableCellWithIdentifier:@"Cell" forIndexPath:indexPath];
    cell.tieziUser_id = self.tieziUser_id;
...
- (void)circleUserListViewCell:(XCZCircleUserListCell *)circleUserListViewCell siteCircleLabelDidClick:(int)clazz
{
    self.goType = 1;
    self.clazz = clazz;
    self.cellUser_id = circleUserListViewCell.row[@"user_id"];
