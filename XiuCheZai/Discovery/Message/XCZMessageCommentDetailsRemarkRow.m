//
//  XCZMessageCommentDetailsRemarkRow.m
//  XiuCheZai
//
...
@implementation XCZMessageCommentDetailsRemarkRow
...
- (void)setupView {
    ...
    for (int i = 0; i<reply_infoArray.count; i++) {
        XCZMessageCommentDetailsRemarkRowReplyView *subViewRow = [[XCZMessageCommentDetailsRemarkRowReplyView alloc] init];
