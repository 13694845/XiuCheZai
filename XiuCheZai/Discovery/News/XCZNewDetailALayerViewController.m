...
@interface XCZNewDetailALayerViewController ()<XCZNewsDetailALayerRowDelegate, UITextFieldDelegate, XCZNewDetailWriteViewDelegate>
...
@property (assign, nonatomic) int goType; // 0:为去点赞(此处没有)，1为主帖评论, 2为下拉加载更多, 3为回复评论, 4为点赞 5为上拉刷新 6收藏 7底部点赞 8.bottomTextField上遮盖被点击
...
//     NSLog(@"publisher_id:%@, artid:%@", self.publisher_id, self.artid);
