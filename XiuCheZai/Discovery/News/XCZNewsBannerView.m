...
@interface XCZNewsBannerView () <UIScrollViewDelegate>
...
@implementation XCZNewsBannerView
...
- (NSURL *)imageURLAtIndex:(int)index {
    ...
    return [NSURL URLWithString:[NSString stringWithFormat:@"%@/%@", [XCZConfig imgBaseURL], [self.banners[index] objectForKey:kBannerImageKey]]];
}
