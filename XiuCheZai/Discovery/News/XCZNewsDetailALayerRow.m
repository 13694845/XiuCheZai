...
- (void)setupView {
    ...
    NSAttributedString *attributeStr = [self changeRichText:_remark[@"reply_content"]];
    ...
    NSString *replies = [_remark[@"replies"] stringByReplacingOccurrencesOfString:@"#0A;" withString:@""];
